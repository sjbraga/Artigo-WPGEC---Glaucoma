...
O OCT utiliza feixe de laserpara medir as espessuras das diferentes estruturas através do tempo que cada uma leva para refletir de volta a luz \cite{huang1991}.   %explicar a saida do exame
